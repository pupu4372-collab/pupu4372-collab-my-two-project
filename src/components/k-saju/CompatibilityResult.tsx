...
> = {
  ...
  owner_nourishes_pet: { ko: "집사 → 펫 상생", en: "You nourish pet" },
  pet_nourishes_owner: { ko: "펫 → 집사 상생", en: "Pet nourishes you" },
  owner_controls_pet: { ko: "집사 극 펫", en: "You shape pet" },
  pet_controls_owner: { ko: "펫 극 집사", en: "Pet leads you" },
...
const LABELS = {
  ...
  en: {
    ...
    petEl: "Pet element",
    ownerEl: "Your element",
    petGender: "Pet gender",
    ownerGender: "Your gender",
    malePet: "Male",
    femalePet: "Female",
    maleOwner: "Male",
    femaleOwner: "Female",
