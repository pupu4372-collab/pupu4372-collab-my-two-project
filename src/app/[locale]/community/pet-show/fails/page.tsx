  ...
  return (
    ...
    >
      <div className="space-y-10">
        <section className="relative overflow-hidden rounded-[2rem] border border-white/20 bg-white/12 p-6 text-white shadow-sm backdrop-blur-sm md:p-8">
          <div className="pointer-events-none absolute -right-12 -top-16 h-48 w-48 rounded-full bg-[#ffd7ff]/20 blur-3xl" />
          <div className="relative">
            <p className="text-xs font-extrabold uppercase tracking-[0.22em] text-[#ffd7ff]">
              Pet Show Fails
            </p>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              ...
              <Link
                ...
                className="rounded-full border border-white/30 bg-white/10 px-6 py-3 text-sm font-extrabold text-white transition hover:bg-white/20"
              >
        ...
        <section className="grid gap-4 md:grid-cols-3">
          {prompts.map((prompt) => (
            <article key={prompt.title} className="rounded-[1.5rem] border border-white/20 bg-white/80 p-5 shadow-sm">
