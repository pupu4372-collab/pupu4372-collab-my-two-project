...
※ 개체마다 차이가 있을 수 있으며, 건강 이상 시 전문가 상담을 권합니다.`,
  ...
  {
    breed_name: "말티푸",
    breed_name_en: "Maltipoo",
    animal_type: "dog",
    size_category: "small",
    lifespan: "12–15년",
    personality:
      "말티푸는 말티즈와 푸들의 성향이 함께 이야기되는 소형견으로, 보호자와의 교감과 놀이에 반응이 좋은 경우가 많아요. 개체에 따라 예민함이나 분리불안, 피부 관리 이슈가 함께 나타날 수 있어요.",
    health_notes:
      "피부 알레르기, 귀 관리, 눈물, 치아 문제는 말티푸 보호자들이 자주 살피는 포인트예요. 반복적인 긁음이나 발 핥기, 귀 냄새가 이어지면 수의사 상담을 권해요.",
    exercise_level: "medium",
    grooming_level: "high",
    beginner_friendly: true,
    saju_tendency: "목(木)·수(水) — 교감 놀이와 안정적인 휴식 루틴을 함께 맞추면 좋은 경향",
    seo_slug: "maltipoo",
    summary: "말티즈와 푸들의 매력이 함께 이야기되는 소형견이에요. 피부·귀·눈물 관리와 교감 루틴을 함께 챙겨 주세요.",
    body: `함께 지내기
말티푸는 사람과 함께하는 놀이와 교감에 반응이 좋은 경우가 많아요. 다만 개체에 따라 낯선 환경이나 혼자 있는 시간에 예민하게 반응할 수 있어, 안정적인 생활 리듬을 만들어 주는 편이 좋아요.

일상 관리
· 산책/놀이: 짧은 산책과 실내 노즈워크, 가벼운 훈련 놀이를 섞어 주세요.
· 식사: 피부 반응과 체중 변화를 보며 사료와 간식을 단순하게 관리하면 좋아요.
· 그루밍: 털이 엉키기 쉬워 정기 미용과 빗질 루틴이 필요해요.
· 피부/귀 관리: 발 핥기, 귀 냄새, 붉어짐을 꾸준히 관찰해 주세요.

환경·루틴
침구와 생활공간 위생을 유지하고, 혼자 있는 시간을 짧게부터 연습하면 안정에 도움이 될 수 있어요.

주의할 점
피부가 진물나거나 밤에도 계속 긁고, 귀 염증이 반복되면 일반 관리만으로 보기 어려울 수 있어요. 필요하면 수의사·전문가 상담을 받아 보세요.

K-Saju 활용 팁
목(木)의 탐색 에너지와 수(水)의 안정 루틴을 함께 보는 관점으로, 말티푸에게는 놀이와 휴식의 균형을 맞추는 힌트가 될 수 있어요.
...
※ 개체마다 차이가 있을 수 있으며, 건강 이상 시 전문가 상담을 권합니다.`,
  ...
  {
    breed_name: "먼치킨",
    breed_name_en: "Munchkin",
    animal_type: "cat",
    size_category: "small",
    lifespan: "12–15년",
    personality:
      "먼치킨은 짧은 다리와 호기심 많은 성향으로 알려져 있어요. 높은 곳을 무리하게 오르내리기보다 낮은 동선에서 놀이와 탐색을 즐길 수 있게 해 주면 좋아요.",
    health_notes:
      "체형 특성상 관절 부담과 체중 관리를 꾸준히 살피는 편이 좋아요. 점프 회피, 절뚝임, 움직임 감소, 체중 증가가 보이면 수의사 상담을 권합니다.",
    exercise_level: "medium",
    grooming_level: "low",
    beginner_friendly: true,
    saju_tendency: "토(土) — 낮고 안정적인 동선과 규칙적인 놀이 루틴에서 편안해지는 경향",
    seo_slug: "munchkin",
    summary: "짧은 다리와 호기심 많은 성향이 매력적인 고양이예요. 관절 부담을 줄이는 낮은 동선과 체중 관리가 중요해요.",
    body: `함께 지내기
먼치킨은 호기심이 많고 놀이에 반응이 좋은 경우가 많아요. 다만 짧은 다리 체형을 고려해 높은 곳을 반복해서 오르내리는 환경보다 낮고 안정적인 동선을 만들어 주는 편이 좋아요.

일상 관리
· 놀이: 낮은 높이의 낚싯대 놀이와 바닥 사냥 놀이를 짧게 반복해 주세요.
· 식사: 체중 증가는 관절 부담으로 이어질 수 있어 정량 급여와 간식 조절이 중요해요.
· 그루밍: 단모라도 털갈이 시기에는 빗질이 도움이 돼요.
· 관절 관찰: 점프, 착지, 걷는 속도와 자세 변화를 평소와 비교해 주세요.

환경·루틴
낮은 캣타워, 미끄럼 방지 매트, 쉽게 오르내릴 수 있는 발판이 도움이 될 수 있어요. 무리한 점프를 유도하는 놀이보다 안전한 탐색 루틴을 우선해 주세요.

주의할 점
절뚝거림, 움직임 감소, 만졌을 때 예민한 반응, 갑작스러운 활동성 저하가 보이면 확인이 필요할 수 있어요. 이상 증상은 수의사 상담을 받아 보세요.

K-Saju 활용 팁
토(土) 기운은 안정적인 바닥과 반복 루틴의 이미지와 어울려요. 먼치킨에게는 낮고 편안한 동선과 규칙적인 놀이 시간을 먼저 설계해 보세요.
