...
★ 상세도:
  - ★현재 대운 + ★다음 대운만 각각 5년(전반/후반) 2블록으로 세분
  - '다음 대운' = 현재 대운 바로 다음 1개만 (입력의 ★다음 대운 마크·코드 산출 구간)
  - 그 이후 먼 대운·과거는 10년 통짜 1블록 (다음처럼 5년 쪼개지 말 것)
  - 다음 대운을 "2033~2042년 (다음 대운)"처럼 10년 한 블록으로 쓰는 것 금지`;
